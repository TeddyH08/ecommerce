...
<div class="container cat">
    <h1>Plus beaucoup en stock, dépéchez-vous !</h1>
<div class="nouveaute-tb">
        <?php
        $sel = "SELECT * FROM articles a, stocks s, couleurs c
        WHERE s.id_articles=a.id_articles
        AND s.id_couleurs=c.id_couleurs
        AND s.quantite_stock <= 5
        AND a.id_categories != 3 ORDER BY s.id_articles DESC LIMIT 15";
